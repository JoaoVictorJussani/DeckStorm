...
- Tous les élèves ont un compte sur l'infra IceScrum ETML (https://etml.icescrum.com) et **pas** sur le IceScrum public (https://www.icescrum.com/). Leur nom d'utilisateur doit permettre de les identifier sans ambiguité (p.ex: `Lucas 2` n'est pas OK)
